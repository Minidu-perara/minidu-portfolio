...
function Sidebar({ active, setActive }: SidebarProps) {
  ...
  return (
    <nav className="hidden md:flex fixed top-14 left-0 h-[calc(100vh-3.5rem)] flex-col gap-4 w-64 px-4 py-8 border-r border-white/10 backdrop-blur-md bg-black/60 rounded-tr-2xl rounded-br-2xl shadow-2xl z-30 transition-all">
      {sidebarGroups.map(group => (
        <div key={group.label} className="mb-2">
          <button
            className="uppercase text-[11px] text-gray-400 mb-2 font-bold flex items-center gap-2 focus:outline-none tracking-widest"
              ...
              <a
                ...
                className={`block pl-3 pr-2 py-1 border-l-2 transition font-normal text-left
                  ${active === sec.id
                    ...
                    : "border-transparent text-gray-200 hover:underline hover:text-indigo-300 hover:pl-4 hover:border-indigo-300"
                  }`
                }
...
export default function PortfolioPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="ml-64 flex flex-col gap-24 px-4 md:px-16 py-16 md:py-24 min-h-screen bg-transparent border-l border-white/10 pt-14" style={{ position: 'relative' }}>
        <div id="intro" ref={el => { sectionRefs.current[0] = el; }} className="w-full ml-0">
          <div className="w-full flex flex-col md:flex-row items-center md:items-center justify-between gap-8 mb-16">
            <div className="flex flex-col md:flex-row items-center md:items-center gap-8 flex-1">
              <div className="flex-shrink-0 flex flex-col items-center justify-center">
                <Image
                  ...
                  width={160}
                  height={160}
                  className="rounded-xl border-4 border-indigo-900 shadow-lg object-cover w-40 h-40 mb-4 md:mb-0"
                />
              </div>
            ...
            <div className="flex-shrink-0 w-full md:w-auto md:max-w-sm ml-auto flex items-center md:items-center justify-center md:justify-end mt-6 md:mt-0">
              <ResumeDownload />
            </div>
          </div>
        </div>
        <div id="education" ref={el => { sectionRefs.current[1] = el; }} className="w-full max-w-4xl ml-0 mt-8">
        ...
        <div id="projects" ref={el => { sectionRefs.current[3] = el; }} className="w-full max-w-4xl ml-0">
          ...
          <div className="flex flex-col gap-6 ml-0 w-full">
            ...
            <div className="bg-gradient-to-br from-white/10 via-black/30 to-white/5 rounded-2xl p-10 shadow-2xl border-l-4 border-indigo-500 w-full transition-transform duration-200 hover:shadow-xl hover:scale-[1.01] mb-6">
